...
<div>
   <div class="carousel-inner relative overflow-hidden w-full">
    ...
    <div class="carousel-item absolute opacity-0" style="height:50vh;">
        <div class="block h-full w-full mx-auto flex pt-6 md:pt-0 md:items-center bg-cover bg-right" style="background-image: url('side1.jpg');">
        ...
        <div class="container mx-auto flex items-center flex-wrap pt-4 pb-12">
            ...
            @foreach ($products as $product)
                ...
                <a href="{{route('product.details',['id' =>$product->id ])}}">
                    ...
                    <img class="hover:grow hover:shadow-lg w-full h-48 object-cover" src="{{ asset('storage/'.$product->image) }}" alt="Product Image">
